  async function getWeatherWithProbability() {
    ...
    const apiUrl = `https://api.open-meteo.com/v1/forecast?latitude=${latitude}&longitude=${longitude}&daily=temperature_2m_max,temperature_2m_min,weathercode,precipitation_probability_mean&timezone=Asia%2FKolkata&start_date=${todayFormatted}&end_date=${nextDayFormatted}`;
      ...
      if (data.daily && data.daily.time && data.daily.time.length >= 3) {
        ...
        for (let i = 0; i < 3; i++) {
          ...
          switch (weatherCode) {
            ...
            case 1:
            case 2:
            case 3: skyCondition = 'Partly cloudy'; break;
            case 45:
            case 48: skyCondition = 'Fog'; break;
            case 51:
            case 53:
            case 55: skyCondition = 'Drizzle'; break;
            case 56:
            case 57: skyCondition = 'Freezing Drizzle'; break;
            case 61:
            case 63:
            case 65: skyCondition = 'Rain'; break;
            case 66:
            case 67: skyCondition = 'Freezing Rain'; break;
            case 71:
            case 73:
            case 75: skyCondition = 'Snow fall'; break;
            case 77: skyCondition = 'Snow grains'; break;
            case 80:
            case 81:
            case 82: skyCondition = 'Rain showers'; break;
            case 85:
            case 86: skyCondition = 'Snow showers'; break;
            case 95: skyCondition = 'Thunderstorm'; break;
            case 96:
            case 99: skyCondition = 'Thunderstorm++'; break;
